...
//     setLoading(true);
//     try {
//       const response = await axios.post("http://localhost:8081/api/students/verify-otp", {
...
const VerifyOtp = () => {
  ...
  const roleEndpoints = {
    student: "http://localhost:8081/api/students/verify-otp",
    faculty: "http://localhost:8081/api/faculty/verify-otp",
    coordinator: "http://localhost:8081/api/coordinators/verify-otp"
  };
