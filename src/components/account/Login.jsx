...
//     setLoading(true);
//     try {
//       const response = await axios.post("http://localhost:8081/api/faculty/signin", formData);

//       console.log("Login response:", response.data);

//       if (response.data.message.includes("Faculty not verified yet")) {
//         alert("OTP sent. Please verify.");
//         navigate("/verifyfaculty-otp");
//       } else if (response.data.token) {
//         localStorage.setItem("studentToken", response.data.token); // Store token
//         alert("Login successful!");
...
//       const endpoint = "http://localhost:8081/api/coordinators/signin";
...
//     setLoading(true);
//     try {
//       const response = await axios.post('http://localhost:8081/api/coordinators/signup', {
//         name: formData.name,
...
//     setLoading(true);
//     try {
//       const response = await axios.post(`http://localhost:8081/api/${selectedRole}s/verify-otp`, {
//         email: formData.email,
//         otp: formData.otp,
//       });
//       navigate('/success');
...
const Login = () => {
  ...
  const validateForm = () => {
    ...
    //   errorMessages.password = 'Password must contain at least one uppercase letter, one lowercase letter, and one number';
    //   valid = false;
    // }
