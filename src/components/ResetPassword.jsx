...
//       const response = await fetch('http://localhost:8081/api/students/reset-password', {
//         method: 'POST',
//         headers: {
...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      ? `http://localhost:8081/api/${role}/reset-password`
      : `http://localhost:8081/api/${role}s/reset-password`;
