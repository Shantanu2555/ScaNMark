...
function StudentModifyPage() {
  ...
  const handleAddStudent = async () => {
    ...
    try {
      await axios.post("/api/coordinators/add-student", formData, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const handleSaveStudent = async () => {
    try {
      await axios.put(`/api/coordinators/update-student/${editingPrn}`, formData, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
          "Content-Type": "application/json",
        },
  ...
  const handleDeleteStudent = async (prn) => {
    try {
      await axios.delete(`/api/coordinators/delete-student/${prn}`, {
